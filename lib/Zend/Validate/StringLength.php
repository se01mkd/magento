...
class Zend_Validate_StringLength extends Zend_Validate_Abstract
{
    ...
    {
        if ($encoding !== null) {
            $orig   = iconv_get_encoding(ini_get('default_encoding'));
            $result = iconv_set_encoding(ini_get('default_encoding'), $encoding);
            if (!$result) {
                #require_once 'Zend/Validate/Exception.php';
                throw new Zend_Validate_Exception('Given encoding not supported on this OS!');
            }

            iconv_set_encoding(ini_get('default_encoding'), $orig);
        }
